  ...
  return (
    <header className="h-16 bg-white/90 backdrop-blur border-b border-slate-200 flex items-center justify-between px-4 sm:px-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-xs uppercase tracking-[0.2em] text-slate-500">Restaurant Operations</p>
          <h2 className="text-sm sm:text-base font-semibold text-slate-900">TablePilot Command Center</h2>
        </div>
      </div>
